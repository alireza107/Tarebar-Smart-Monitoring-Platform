...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/compare-locations': 'مقایسه مکان‌ها', '/reports/executive': 'گزارش مدیریتی اجرایی', '/reports/quality': 'گزارش کیفیت میوه',
  '/reports': 'گزارش‌ها', '/locations': 'مدیریت نواحی', '/camera-calibration': 'کالیبراسیون دوربین',
