...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/live-analytics/fruit': 'تحلیل زنده میوه', '/live-analytics/video-insight': 'درک زنده ویدیو',
  '/live-analytics': 'تحلیل زنده دوربین‌ها',
  '/video-analysis': 'تحلیل ویدیو', '/analytics': 'مانیتورینگ افراد', '/fruit-analysis': 'تحلیل میوه', '/video-insight': 'درک ویدیو',
